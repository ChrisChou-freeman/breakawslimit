    ...
    return new Promise((resolve)=>{
      ...
      iot.listTargetsForPolicy(params, function(err, data) {
        if(err){
          ...
          console.error('listTargetsForPolicyErr>>>', err.stack);
          resolve(returnData);
          return;
        }
    ...
    return new Promise((resolve)=>{
      ...
      iot.detachPolicy(params, function(err, data) {
        if(err){
          ...
          console.error('detachPolicy>>>', err.stack);
          resolve(returnData);
          return;
        }
    ...
    return new Promise((resolve)=>{
      ...
      iot.deletePolicy(params, function(err, data) {
        if (err){
          ...
          console.error('deletePolicyErr>>>', err.stack);
          resolve(returnData);
          return;
        }
        returnData.data = data;
    ...
    return new Promise((resolve)=>{
      ...
      iot.createPolicy(params, function(err, data) {
        if (err){
          ...
          // logger.loggerError.info({info: err.stack, source: 'deletePolicy'});
          console.error('createPolicyErr>>>', err.stack);
          resolve(returnData);
          return;
        }
        returnData.data = data;
    ...
    return new Promise((resolve)=>{
      ...
      iot.attachPolicy(params, function(err, data) {
        if(err){
          ...
          console.error('attachPolicyErr>>>', err.stack);
          resolve(returnData);
          return;
        }
        returnData.data = data;
    ...
    return new Promise((resolve)=>{
      ...
      iot.listAttachedPolicies(params, function(err, data) {
        if(err){
          ...
          console.error('listAttachedPoliciesErr>>', err.stack);
          resolve(returnData);
          return;
        }
